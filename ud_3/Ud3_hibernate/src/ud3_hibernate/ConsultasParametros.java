...
public class ConsultasParametros {
	...
	public static void main(String[] args) {
		...
		q1.setParameter("numemple", (short) 7369); //Se castea por que la clase este atributo es de tipo float
		...
		String hql3 = "from Empleados emp where emp.departamentos.deptNo = ? and emp.oficio = ?"; // Se deberia instanciar en orden, empieza por 0, en prepared Statement empezaba en 1
