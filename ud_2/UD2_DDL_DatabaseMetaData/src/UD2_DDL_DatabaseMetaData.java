/* Obtiene informaci�n de la base de datos y de las tablas y vistas */

import java.sql.*;

public class UD2_DDL_DatabaseMetaData {
	...
	public static void main(String[] args) {
	  try
	  {
         ...
         DatabaseMetaData dbmd = conexion.getMetaData(); // Creamos objeto DatabaseMetaData
  		 ...
  		 // USa varios m�todos del objeto DatabaseMetaData para obtener inf
         ...
         System.out.println("===================================");
         System.out.println("INFORMACI�N SOBRE LAS TABLAS Y VISTAS:");
  		 System.out.println("===================================");
         while (resul.next()) {			   
