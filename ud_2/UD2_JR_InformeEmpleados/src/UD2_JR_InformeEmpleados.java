/* Uso de plantilla de JasperReports para generar informes de distintos formatos 6*/
...
public class UD2_JR_InformeEmpleados {
	...
	public static void main(String[] args) {
		...
		try {
			...
			JasperPrint MiInforme = JasperFillManager.fillReport(jasperReport, null, conn);
