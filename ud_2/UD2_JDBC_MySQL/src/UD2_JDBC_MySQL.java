// Conexi�n a servidor MySQL

// Paso 1. Importar las clases necesarias

import java.sql.*;

public class UD2_JDBC_MySQL {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// String url = "jdbc:mysql://localhost:3306/ud2_mysql";
			String url = "jdbc:mysql://localhost:3306/ud2_mysql";
			
			/*
			 * String url = "jdbc:mysql://localhost:3306/ud2_mysql" + "?useUnicode=true&use"
			 * + "JDBCCompliantTimezoneShift=true&useLegactDateTimeCode=false&"
			 * +"serverTimezone=UTC";
			 */
