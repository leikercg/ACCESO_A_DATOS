/* Inserta un registro en un fichero aleatorio del que conoce su estructura (tamaño del registro).
 * Calcula la posición y se posiciona con el método seek(posición)
 */
