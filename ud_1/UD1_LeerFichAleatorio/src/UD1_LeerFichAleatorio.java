 ...
 * Para la lectura de los datos debemos controlar la posici�n del puntero dentro del fichero
 * (m�todo getFilePointer), sabiendo el tama�o de cada registro y
 * controlando el tama�o del fichero (m�todo length).
 * El desplazamiento dentro del fichero se realiza con el m�todo seek(posici�n).
 */
