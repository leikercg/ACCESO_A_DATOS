/* Escribe bytes en un fichero (si no existe lo crea el constructor) y después los visualiza. Al elegir el constructor del flujo de salida se puede optar por adjuntar datos al fichero ya existente (append = true)
El método read() devuelve -1 cuando no hay dato a leer.
*/
...
public class UD1_EscribirFichBytes {
	...
	public static void main(String[] args) throws IOException {   
	  ...
	  // FileOutputStream fileout = new FileOutputStream(fichero, true); // Adjuntar al fichero de salida
