 ...
 * El número del registro se pasa como parámetro al programa.
 */
...
public class UD1_LeerFichAleatorioUnReg {
   ...
   posicion = (registro -1 ) * 36;  //clacula la posición
   
   if(posicion >= file.length() )   //comprueba si la posición está dentro de la longitud del fichero
