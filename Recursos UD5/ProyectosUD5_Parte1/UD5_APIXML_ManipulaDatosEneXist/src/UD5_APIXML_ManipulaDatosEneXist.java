// Ejemplos de manipulación de datos sobre BD eXist desde Java con API XML:DB
...
public class UD5_APIXML_ManipulaDatosEneXist {
  ...
  public static void main(String[] args) throws Exception {
		...
		String URI = "xmldb:exist://localhost:8090/exist/xmlrpc/db/ColeccionPruebas";
		String usu = "admin"; 
		String pwd = "Ad1rectory"; 
		...
		try {
			...
			if (col == null) {
				...
				String consultaXPath = "update insert "
									+ "<filadpto><DEPT_NO>50</DEPT_NO>"
									+ "<DNOMBRE>CONTABILIDAD</DNOMBRE> "
									+ "<LOC>ALBACETE</LOC></filadpto>"
				...
				consultaXPath = "/departamentos/filadpto[DEPT_NO = 50]/LOC/text()";
				resultSet = servicio.query(consultaXPath);
				...
				consultaXPath = "update delete "
									+ "doc('/ColeccionPruebas/departamentos.xml')/departamentos/filadpto[DEPT_NO = 50] ";
				resultSet = servicio.query(consultaXPath);
				System.out.println("MODIFICADA LOCALIDAD EN DEPARTAMENTO.");
				
				// OBTENGO DATOS, departamentos
				consultaXPath = "/departamentos/filadpto[DEPT_NO = 50]";
				resultSet = servicio.query(consultaXPath);
