// Ejemplo de Gestión de Excepciones en BD eXist desde Java con API XML:DB
...
public class UD5_APIXML_GestionExcepciones {
	...
	public static void main(String[] args) throws Exception {
		...
		String URI = "xmldb:exist://localhost:8090/exist/xmlrpc";
		Database db;
		String usu ="admin";
		...
		try {  // Cierra la conexión con la colección
			col.close();
		}catch ( NullPointerException n){
