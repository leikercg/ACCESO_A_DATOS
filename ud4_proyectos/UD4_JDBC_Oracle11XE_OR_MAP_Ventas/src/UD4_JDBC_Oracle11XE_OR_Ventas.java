// Conexi�n a servidor Oracle 11g XE y tablas de objetos
...
public class UD4_JDBC_Oracle11XE_OR_Ventas {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Consulta Pedidos de venta con su importe total, que se obtiene llamando al m�todo TOTAL_VENTA()
			...
			// Consulta el nombre del cliente y su direcci�n de una determinada venta
			...
			System.out.println("-----------------------------");
			while (res.next() ) {
				//Recupero los atributos de la direcci�n que es objeto
				...
				System.out.printf("Cliente: %s , Direcci�n: %s, %s, %s, %s %n", 
