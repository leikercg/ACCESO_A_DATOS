/* Ejemplo de programa que captura varios tipos de excepción
 * 
 */

public class UD1_EjemploExcepciones {
  ...
  public static void main(String[] args) {   
    ...
    catch (Exception ex) {   // La clase Exception debe ponerse al final
    ...
    System.out.println("El mensaje de la excepción capturada es: " + mensaje); 
