...
@XmlRootElement(name = "libro") // Le indicamos el elemento ra�z
...
public class Libro { 
	...
	public Libro() {}					// Constructor sin par�metros
    
	@XmlAttribute(name = "isbn")		// declara que isbn es un atributo // este nombre será el que aparezaca en la etiqueta
